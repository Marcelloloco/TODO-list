The main.py file contains all the funcionality, like creating the models, the session and defining all the methods for adding, deleting entries etc as well as rendering the templates
